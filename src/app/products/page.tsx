    ...
    <div className="min-h-screen py-12">
      ...
      {loading ? (
        ...
        <motion.div
          ...
          className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 px-4 md:px-8 max-w-7xl mx-auto"
        >
          {products.map((product, idx) => {
            ...
            return (
              <motion.div
                ...
                className="group"
              >
                <div className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 cursor-pointer relative">
                  {/* Image */}
                  <div
