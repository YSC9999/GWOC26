...
export default function Cart() {
  ...
  return (
    <div
      className="min-h-screen py-12 px-4 md:px-8 bg-[#FDF8F3] bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-[#EFE5D8]/40 via-[#FDF8F3] to-[#F5EDE4]"
    ...
    >
      ...
      <div className="fixed top-0 left-0 w-full h-full pointer-events-none overflow-hidden z-0">
        <div className="absolute top-[-10%] left-[-5%] w-[600px] h-[600px] bg-[#C97C5D]/5 rounded-full blur-[120px]" />
        <div className="absolute bottom-[10%] right-[-5%] w-[500px] h-[500px] bg-[#5A3E36]/5 rounded-full blur-[100px]" />
      </div>
