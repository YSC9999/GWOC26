            ...
            {data.recentOrders.map((order: any) => (
              ...
              >
                ...
                <div className="text-right">
                  ...
                  <span
                    className={`text-[10px] px-2 py-0.5 rounded-full font-bold ${order.status === "delivered"
      ...
      < div className = "bg-white/60 backdrop-blur p-8 rounded-3xl shadow-sm border border-white/60" >
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
            ...
            <div className="flex bg-white border border-soil/5 p-1 rounded-full text-xs font-medium shadow-sm">
              <button
                onClick={() => setChartMode("revenue")}
                className={`px-4 py-1.5 rounded-full transition-all ${chartMode === "revenue"
              ...
              <button
                onClick={() => setChartMode("orders")}
                className={`px-4 py-1.5 rounded-full transition-all ${chartMode === "orders"
                  ? "bg-soil text-white shadow-md"
                  : "text-soil/40 hover:text-soil"
                  } `}
              >
                ...
                <div key={i}>
                  ...
                  <div className="w-full bg-sand/20 rounded-full h-2">
                    <div
                      className="bg-soil h-2 rounded-full"
                      style={{
                        width: `${(product.revenue / data.summary.totalRevenue) * 100
                          }%`,
                      }}
                    />
                  </div>
