...
import { ArrowUpRight, Filter, MoreHorizontal, User, Edit2, Check, X as XIcon, TrendingUp, TrendingDown, DollarSign, Package } from "lucide-react";
...
export default function AnalyticsPage() {
    ...
    if (loading) return <div className="min-h-screen flex items-center justify-center bg-amber-50 text-soil font-serif text-xl">Loading Dashboard...</div>;
    if (!data) return <div className="text-center py-20 bg-amber-50 min-h-screen text-soil">Failed to load data</div>;
