...
export default function AnalyticsPage() {
  ...
  if (loading)
    return (
      <div className="min-h-screen flex items-center justify-center bg-amber-50 text-soil font-serif text-xl">
        Loading Dashboard...
      </div>
    );
  if (!data)
    return (
      <div className="text-center py-20 bg-amber-50 min-h-screen text-soil">
        Failed to load data
      </div>
    );
  ...
  const gaugeData = [
    { name: "Sales", value: salesValue, fill: "#D27D2D" }, // Clay Color
    {
      name: "Remaining",
      value: Math.max(0, targetValue - salesValue),
      fill: "#E5E7EB",
    },
  ];
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-clay/10 p-6 font-sans text-soil"
    ...
    >
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4 max-w-7xl mx-auto">
        <div className="flex items-center gap-4">
          <Link
            href="/admin"
            className="text-soil/40 hover:text-soil transition-colors font-medium"
          >
            ← Admin
          </Link>
        ...
        <div className="flex w-full md:w-auto items-center justify-between md:justify-end gap-3 bg-white/50 backdrop-blur border border-white/60 p-2 rounded-xl shadow-sm">
          ...
          <button
            ...
            className="bg-soil text-white p-2 rounded-lg hover:bg-clay transition-colors shadow-lg shadow-soil/10"
          >
            <Filter size={16} />
          </button>
        </div>
                  ...
                  <div key={i}>
                    ...
                    <div className="w-full bg-sand/20 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${
                            (product.revenue / data.summary.totalRevenue) * 100
                          }%`,
                        }}
                      />
                    </div>
