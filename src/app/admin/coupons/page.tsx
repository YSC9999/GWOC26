...
export default function AdminCouponsPage() {
  ...
  return (
    <AdminPageContainer title="Coupons">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    <DatePicker
                      ...
                      onChange={(date) =>
                        setFormData({ ...formData, validFromDate: date })
                      }
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    <DatePicker
                      ...
                      onChange={(date) =>
                        setFormData({ ...formData, validToDate: date })
                      }
          ...
          <div className="lg:col-span-2 space-y-4">
              ...
              <button
                ...
                className={`pb-2 px-4 font-medium transition-colors border-b-2 ${
                  activeTab === "active"
                    ...
                    : "text-soil/60 hover:text-soil border-transparent"
                }`}
              >
                Active Coupons
              </button>
            ...
            {loading ? (
              ...
              <div className="text-center py-10 bg-sand/20 rounded-xl">
