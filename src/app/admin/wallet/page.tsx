  ...
  return (
    <div className="p-4 md:p-8 max-w-4xl mx-auto">
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-serif font-bold text-soil flex items-center gap-3">
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-lg border border-soil/10 overflow-hidden">
        ...
        <div className="flex border-b border-soil/10">
          <button
            ...
            className={`flex-1 p-4 font-bold flex items-center justify-center gap-2 transition-colors ${activeTab === "single"
                ? "bg-soil text-white"
          ...
          <button
            ...
            className={`flex-1 p-4 font-bold flex items-center justify-center gap-2 transition-colors ${activeTab === "random"
                ? "bg-clay text-white"
