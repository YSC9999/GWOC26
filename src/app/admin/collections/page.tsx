            ...
            {isEditing ? (
                ...
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-4">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-soil mb-1">Slug (URL)</label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-soil mb-1">Description (Optional)</label>
                                <textarea
                            ...
                            <div className="flex items-center gap-3">
                                <label className="flex items-center gap-2 cursor-pointer">
                                    <input
                                        ...
                                        onChange={(e) => setCurrentCollection({ ...currentCollection, isActive: e.target.checked })}
                        ...
                        <div className="space-y-4">
                            <label className="block text-sm font-medium text-soil mb-1">Add Products</label>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {collections.map((collection) => (
                        <div key={collection._id} className="bg-white border border-soil/10 rounded-2xl p-6 hover:shadow-lg transition-all group">
                            <div className="flex justify-between items-start mb-4">
                                <div>
                                    <h3 className="text-xl font-bold text-soil font-serif">{collection.title}</h3>
                                    <span className={`text-xs px-2 py-1 rounded-full ${collection.isActive ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-500'}`}>
                            ...
                            <p className="text-soil/60 text-sm mb-4 line-clamp-2 h-10">{collection.description || "No description"}</p>
                            <div className="flex items-center gap-2 text-sm text-soil/50 bg-sand/20 p-3 rounded-lg">
                                <div className="flex -space-x-2">
                                    {collection.products.slice(0, 3).map((p) => (
                                        <div key={p._id} className="w-6 h-6 rounded-full bg-gray-200 border-2 border-white overflow-hidden">
