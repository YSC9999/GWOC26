        ...
        <div className="flex flex-col md:flex-row w-full h-full overflow-y-auto md:overflow-hidden">
          ...
          <div className="w-full md:w-1/2 p-8 md:p-10 flex flex-col h-full overflow-y-auto">
             <div className="mb-auto">
                ...
                <div className="flex items-center gap-4 mb-6">
                   <div className="flex items-baseline gap-2">
                      <span className="text-2xl font-bold text-clay">₹{product.price.toLocaleString()}</span>
                      {product.originalPrice && (
                        <span className="text-sm text-soil/40 line-through">₹{product.originalPrice}</span>
                      )}
                   </div>
                   {product.rating > 0 && (
             ...
             <div className="mt-8 pt-6 border-t border-soil/10 text-center">
                <Link href={`/products/${params.id}`} className="text-sm text-soil/60 hover:text-clay hover:underline">
                  View Full Details
                </Link>
             </div>
          </div>
