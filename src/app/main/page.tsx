...
export default function MainHome() {
  ...
  const products = [
    { id: 1, name: "Clay Vessel", tier: "tier-1", image: "🏺", price: "$45" },
    { id: 2, name: "Soil Canvas", tier: "tier-2", image: "🎨", price: "$60" },
    {
      id: 3,
      name: "Sand Sculpture",
      tier: "tier-1",
    ...
    { id: 4, name: "Ink Painting", tier: "tier-0", image: "🖼️", price: "$75" },
    { id: 5, name: "Ceramic Bowl", tier: "tier-2", image: "🍶", price: "$50" },
    { id: 6, name: "Stone Carving", tier: "tier-3", image: "⛏️", price: "$85" },
  ];
